...
<s:form method="post" action="MemberJoinAction" name="userinput" enctype="multipart/form-data" onsubmit="return checkIt();">
	...
	<s:hidden name="nickcheckresult" value="<s:property value='nickcheckresult'/>"/>
	<s:hidden name="emailcheckresult" value="<s:property value='emailcheckresult'/>"/>
	<table align="center">
	<tr height="50"><td></td></tr>
		...
		<tr height="40">
        	...
        	<td width="140"><b>아이디 <font color="#FF0000">*</font></b></td>
         	<td width="190">
				<input class="bottom" id="bu_in" type="text" name="m_id" maxlength="12" autocomplete="off">
			</td>
			<td>
		...
		<tr height="40">
			...
			<td>
				<input class="bottom" id="bu_in" type="password" name="m_passwd" size="20" autocomplete="off">
			</td>
			<td class="font_12">
		...
		<tr height="40">
        	<td width="70"></td>
         	...
         	<td>
            	<input class="bottom" id="bu_in" type="password" name="m_passwd2" size="20" autocomplete="off">
         	</td>
      	</tr> 		
		<tr height="40">
         <td width="70"></td>
         ...
         <td>
            <input class="bottom" id="bu_in" type="text" name="m_name" size="15" maxlength="15" autocomplete="off">
         </td>
      	</tr>
		<tr height="40">
        	<td width="70"></td>
         	...
         	<td>
	            <input class="bottom" id="bu_in" type="text" name="m_nickname" size="15" maxlength="15" autocomplete="off">
         	</td>
         	<td>
		...
		<tr height="40">
        	<td width="70"></td>
         	...
         	<td>
            	<input class="bottom" id="bu_in" type="text" name="m_mobilephone" size="11" autocomplete="off"> 
            </td>
		...
		<tr height="40">
        	<td width="70"></td>
         	...
         	<td>
	            <input class="bottom" id="bu_in" type="text" name="m_birthyear" size="10" autocomplete="off">
        	</td>
		...
		<tr height="40">
        	<td width="70"></td>
         	...
         	<td>
            	<input class="bottom" id="bu_in" type="text" name="m_email" size="30" autocomplete="off">
            </td>
            <td>
