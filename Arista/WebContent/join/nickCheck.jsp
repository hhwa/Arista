...
<table width="500" align="center">
	...
	<tr>
		<td align="center"><s:property value="%{memberResult.m_nickname}"/>는 이미 사용중인 닉네임입니다.</td>
	</tr>	
	<tr height="10"><td></td></tr>	
</table>
...
<table width="500" border="0" cellspacing="0" cellpadding="5">
	...
	<tr>
		<td align="center">
		<input type="submit" value="닉네임 중복확인" id="bu_1">
		</td>
	</tr>	
</table>
</s:form>
...
<table width="500" border="0" cellspacing="0" cellpadding="5">
	<tr>
		<td align="center">
			...
			<input type="button" value="닫기" onclick="setnick()" id="bu_1">
		</td>
	</tr>
</table>
</s:elseif>
