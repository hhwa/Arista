...
<table>
<tr height="23">
   <td id="bu_1" align="center" width=100><a href="modiftyMemberForm.action" style="color: #fff;">수  정</a></td>
   
   <td width=80></td>
   <td id="bu_1" align="center" width=100>
      <a href="#" style="color:#ffffff;" onclick="javascript:open_win_noresizable('deleteMemberPW.action?m_id=<s:property value="memParam.m_id"/>','delete')">탈  퇴</a>
   </td> 
</table>
</center>
