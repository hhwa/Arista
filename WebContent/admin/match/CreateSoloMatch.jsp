...
<s:if test="soloMatchParam.game_day == NULL">
...
<s:else>
	...
	<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
       	...
       	<tr>
        	<td width="100" bgcolor="#F4F4F4"><font color="#FF0000">*</font>  경기 날짜</td>
         	<td width="500" bgcolor="#FFFFFF">
           	<s:if test="soloMatchParam.game_day == null">
         		<input type="date" name="game_day" cssStyle="width:370px" maxlength="50"/>	
         	</s:if>
       	...
       	<tr>
         	...
         	<input type="radio" name="game_type" value="축구"/>축구
           	...
           	<!--<s:textfield name="game_type" theme="simple" value="%{soloMatchParam.game_type}" cssStyle="width:100px" maxlength="20"/>-->
        	</td>
       	</tr>
       	<tr bgcolor="#777777">
         	<td height="1" colspan="2"></td>	
		...
		<tr>
           ...
           <!-- 	<s:textfield name="game_area" theme="simple" value="%{soloMatchParam.game_area}" cssStyle="width:370px" maxlength="50"/> -->
         	</td>
       	</tr>
       	...
       	<tr>
         	...
         	<td bgcolor="#FFFFFF">
           	<s:textfield name="stadium" theme="simple" value="%{soloMatchParam.stadium}" cssStyle="width:100px" maxlength="20"/>
         	</td>
       	</tr>
       	<tr bgcolor="#777777">
         	<td height="1" colspan="2"></td>	
       	...
       	<tr>
        	<td width="100" bgcolor="#F4F4F4"><font color="#FF0000">*</font>  경기 최대 인원</td>
         	<td width="500" bgcolor="#FFFFFF">
         	<input type="number" name="people_max" value="${soloMatchParam.people_max}" cssStyle="width:370px" maxlength="50"/>
           	<%-- <s:textfield name="people_max" theme="simple" value="%{soloMatchParam.people_max}" cssStyle="width:370px" maxlength="50"/> --%>
         	</td>
       	</tr>
       	<tr bgcolor="#777777">
         	<td height="1" colspan="2"></td>	
		...
		<tr>
        	<td width="100" bgcolor="#F4F4F4"><font color="#FF0000">*</font>  비용</td>
         	<td width="500" bgcolor="#FFFFFF">
         	<input type="number" name="fee" value="${soloMatchParam.people_max}" cssStyle="width:370px" maxlength="50"/>
           	<%-- <s:textfield name="fee" theme="simple" value="%{soloMatchParam.fee}" cssStyle="width:370px" maxlength="50"/> --%>
         	</td>
       	</tr>
       	...
       	<tr>
         	...
         	<td bgcolor="#FFFFFF">
           	<s:textarea name="content" theme="simple" value="%{soloMatchParam.content}" cols="50" rows="10" />
         	</td>
       	</tr>
        ...
        <tr>
         	<td align="right" colspan="2">
	         	<input name="submit" type="submit" value="작성완료" class="inputb">
           		<input name="list" type="button" value="목록" class="inputb" onClick="javascript:location.href='SoloMatchList.action?currentPage=<s:property value="currentPage" />'">
        	</td>
       	</tr>
    </table>
    </form>
