...
<%-- s:if로 조건주고 getAttribute로 가져와도 되고, ${ }식 써서 값을 가져올수있다. 두가지방법 --%>
    ...
    <tr>
      <td>&nbsp;&nbsp;내용</td>
      <td>
        <s:textarea name="qna_content" theme="simple" value="%{resultClass.qna_content}" cols="60" rows="10"/>
      </td>
    </tr>
  </table>
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">      
    ...
    <tr>
      <td align="right" colspan="2">
        ...
        <input name="list" type="button" value="취소" onClick="javascript:location.href='QNAList.action?currentPage=<s:property value="currentPage" />'">
        </s:if>
        <s:else>
        <input name="list" type="button" value="취소" onClick="javascript:history.back()">
        </s:else> 
