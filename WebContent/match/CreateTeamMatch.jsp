...
<s:else>
	...
	<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
       	...
       	<tr>
        	<td width="100" bgcolor="#F4F4F4"><font color="#FF0000">*</font>  경기 날짜</td>
         	...
         	<s:else><s:property value="%{teamMatchParam.game_day}"/></s:else>
		...
		<tr>
           ...
           <!-- 	<s:textfield name="game_area" theme="simple" value="%{teamMatchParam.game_area}" cssStyle="width:370px" maxlength="50"/> -->
         	</td>
       	</tr>
       	...
       	<tr>
         	...
         	<td bgcolor="#FFFFFF">
           	<s:textfield name="stadium" theme="simple" value="%{teamMatchParam.stadium}" cssStyle="width:100px" maxlength="20"/>
         	</td>
       	</tr>
       	<tr bgcolor="#777777">
         	<td height="1" colspan="2"></td>	
		...
		<tr>
        	<td width="100" bgcolor="#F4F4F4"><font color="#FF0000">*</font>  비용</td>
         	<td width="500" bgcolor="#FFFFFF">
         	<%-- <s:textfield name="fee" type="number" value="%{teamMatchParam.fee}" cssStyle="width:370px" maxlength="50"/> --%>
         	<input type="number" name="fee" value="${teamMatchParam.fee}" cssStyle="width:370px" maxlength="50"/>
         	</td>
       	</tr>
       	...
       	<tr>
        	<td width="100" bgcolor="#F4F4F4"><font color="#FF0000">*</font>  유니폼 색상</td>
         	<td width="500" bgcolor="#FFFFFF">
           	<s:textfield name="uniform_color" theme="simple" value="%{teamMatchParam.uniform_color}" cssStyle="width:370px" maxlength="50"/>
         	</td>
       	</tr>
       	...
       	<tr>
         	...
         	<td bgcolor="#FFFFFF">
           	...
           	<s:textarea name="content" theme="simple" value="%{teamMatchParam.content}" cols="50" rows="10" />
         	</td>
       	</tr>
